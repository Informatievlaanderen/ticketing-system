...
public static class Handlers
{
    ...
    {
        using(var scope = Tracer.Instance.StartActive("SetTicketPending", new SpanCreationSettings { Parent = new SpanContext(null, ticketId.ToULong()) }))
        {
    ...
    public static async Task Complete(
        ...
        CancellationToken cancellationToken = default)
    {
        using(var scope = Tracer.Instance.StartActive("CompleteTicket", new SpanCreationSettings { Parent = new SpanContext(null, ticketId.ToULong()) }))
        {
    ...
    public static async Task Error(
        ...
        CancellationToken cancellationToken = default)
    {
        using(var scope = Tracer.Instance.StartActive("ErrorTicket", new SpanCreationSettings { Parent = new SpanContext(null, ticketId.ToULong()) }))
        {
    ...
    {
        using(var scope = Tracer.Instance.StartActive("DeleteTicket", new SpanCreationSettings { Parent = new SpanContext(null, ticketId.ToULong()) }))
        {
