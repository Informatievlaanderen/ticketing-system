...
public static class Handlers
{
    public static async Task<Guid> Create([FromBody] IDictionary<string, string>? metadata, ITicketing ticketing, CancellationToken cancellationToken = default)
        => await ticketing.CreateTicket(metadata, cancellationToken);
    ...
    public static async Task Errors(Guid ticketId, TicketError[] errors, ITicketing ticketing, CancellationToken cancellationToken = default)
        => await ticketing.Error(ticketId, errors, cancellationToken);
